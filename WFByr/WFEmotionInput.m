...
@interface WFEmotionInput () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)awakeFromNib {
    ...
    [self.collectionView registerClass:[WFEmotionCell class] forCellWithReuseIdentifier:@"WFEmotionCell"];
    ...
    CGFloat itemWidth = WFSCREEN_W / kASEmotionCellPerRow;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    self.pageControl.currentPage = ceil(scrollView.contentOffset.x / WFSCREEN_W);
