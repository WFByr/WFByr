...
@interface WFBorderLayer : CALayer


@end

@implementation WFBorderLayer
...
- (void)setRightBorderWithWidth:(CGFloat)width color:(UIColor *)color {
    ...
    WFBorderLayer *rightBorder = [WFBorderLayer layer];
...
- (void)layoutSublayersOfLayer:(CALayer *)layer {
    ...
    for (CALayer*aLayer in layers) {
        if ([aLayer isMemberOfClass:[WFBorderLayer class]]) {
...
static NSString * const reuseId = @"WFTop10Cell";

@implementation WFTop10Cell
